...
func (Client_App) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_Bot_d4801982c3016da2, []int{1, 0}
}
...
func (Thread_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_Bot_d4801982c3016da2, []int{2, 0}
}
...
func (*User) Descriptor() ([]byte, []int) {
	return fileDescriptor_Bot_d4801982c3016da2, []int{0}
}
...
type Client struct {
	...
	Agent                Client_App `protobuf:"varint,2,opt,name=agent,enum=protos.Client_App" json:"agent,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
}
...
func (*Client) Descriptor() ([]byte, []int) {
	return fileDescriptor_Bot_d4801982c3016da2, []int{1}
}
...
type Thread struct {
	...
	Type                 Thread_Type          `protobuf:"varint,6,opt,name=type,enum=protos.Thread_Type" json:"type,omitempty"`
...
func (*Thread) Descriptor() ([]byte, []int) {
	return fileDescriptor_Bot_d4801982c3016da2, []int{2}
}
...
func (*GetClientThreadsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_Bot_d4801982c3016da2, []int{3}
}
...
func (*Comment) Descriptor() ([]byte, []int) {
	return fileDescriptor_Bot_d4801982c3016da2, []int{4}
}
...
func (*GetThreadCommentsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_Bot_d4801982c3016da2, []int{5}
}
...
func init() {
	...
	proto.RegisterType((*Client)(nil), "protos.Client")
	proto.RegisterType((*Thread)(nil), "protos.Thread")
	proto.RegisterType((*GetClientThreadsResponse)(nil), "protos.GetClientThreadsResponse")
	proto.RegisterType((*Comment)(nil), "protos.Comment")
	proto.RegisterType((*GetThreadCommentsResponse)(nil), "protos.GetThreadCommentsResponse")
	proto.RegisterEnum("protos.Client_App", Client_App_name, Client_App_value)
	proto.RegisterEnum("protos.Thread_Type", Thread_Type_name, Thread_Type_value)
}
...
func (c *appBotClient) GetClientThreads(ctx context.Context, in *Client, opts ...grpc.CallOption) (*GetClientThreadsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/protos.AppBot/GetClientThreads", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *appBotClient) GetThreadComments(ctx context.Context, in *Thread, opts ...grpc.CallOption) (*GetThreadCommentsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/protos.AppBot/GetThreadComments", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AppBot_GetClientThreads_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.AppBot/GetClientThreads",
	}
...
func _AppBot_GetThreadComments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.AppBot/GetThreadComments",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func init() { proto.RegisterFile("Bot.proto", fileDescriptor_Bot_d4801982c3016da2) }

var fileDescriptor_Bot_d4801982c3016da2 = []byte{
	// 553 bytes of a gzipped FileDescriptorProto
	,
}
