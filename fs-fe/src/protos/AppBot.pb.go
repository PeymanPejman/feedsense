...
func (Client_App) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_AppBot_900e631785a614e2, []int{1, 0}
}
...
func (Thread_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_AppBot_900e631785a614e2, []int{2, 0}
}
...
func (*User) Descriptor() ([]byte, []int) {
	return fileDescriptor_AppBot_900e631785a614e2, []int{0}
}
...
type Client struct {
	...
	Agent                Client_App `protobuf:"varint,2,opt,name=agent,enum=AppBot.Client_App" json:"agent,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
}
...
func (*Client) Descriptor() ([]byte, []int) {
	return fileDescriptor_AppBot_900e631785a614e2, []int{1}
}
...
type Thread struct {
	...
	Type                 Thread_Type          `protobuf:"varint,6,opt,name=type,enum=AppBot.Thread_Type" json:"type,omitempty"`
...
func (*Thread) Descriptor() ([]byte, []int) {
	return fileDescriptor_AppBot_900e631785a614e2, []int{2}
}
...
func (*GetClientThreadsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_AppBot_900e631785a614e2, []int{3}
}
...
func (*Comment) Descriptor() ([]byte, []int) {
	return fileDescriptor_AppBot_900e631785a614e2, []int{4}
}
...
func (*GetThreadCommentsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_AppBot_900e631785a614e2, []int{5}
}
...
func init() {
	proto.RegisterType((*User)(nil), "AppBot.User")
	proto.RegisterType((*Client)(nil), "AppBot.Client")
	proto.RegisterType((*Thread)(nil), "AppBot.Thread")
	proto.RegisterType((*GetClientThreadsResponse)(nil), "AppBot.GetClientThreadsResponse")
	proto.RegisterType((*Comment)(nil), "AppBot.Comment")
	proto.RegisterType((*GetThreadCommentsResponse)(nil), "AppBot.GetThreadCommentsResponse")
	proto.RegisterEnum("AppBot.Client_App", Client_App_name, Client_App_value)
	proto.RegisterEnum("AppBot.Thread_Type", Thread_Type_name, Thread_Type_value)
}
...
func (c *appBotClient) GetClientThreads(ctx context.Context, in *Client, opts ...grpc.CallOption) (*GetClientThreadsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/AppBot.AppBot/GetClientThreads", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *appBotClient) GetThreadComments(ctx context.Context, in *Thread, opts ...grpc.CallOption) (*GetThreadCommentsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/AppBot.AppBot/GetThreadComments", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AppBot_GetClientThreads_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/AppBot.AppBot/GetClientThreads",
	}
...
func _AppBot_GetThreadComments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/AppBot.AppBot/GetThreadComments",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _AppBot_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "AppBot.proto",
}

func init() { proto.RegisterFile("AppBot.proto", fileDescriptor_AppBot_900e631785a614e2) }

var fileDescriptor_AppBot_900e631785a614e2 = []byte{
	// 549 bytes of a gzipped FileDescriptorProto
	,
}
